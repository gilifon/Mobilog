...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ImageButton importFrequencyBtn = (ImageButton)findViewById(R.id.importFrequencyBtn);
        importFrequencyBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (usbService != null) { // if UsbService was correctly binded, Send data
                    usbService.write("FA;".getBytes());
                }
                else
                {
                    Toast.makeText(getApplicationContext(), "USB Service Failed", Toast.LENGTH_SHORT).show();
                }
            }
        });
